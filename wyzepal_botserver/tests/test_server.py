...
from wyzepal_botserver import server
from wyzepal_botserver.input_parameters import parse_args
...
class BotServerTests(BotServerTestCase):
    ...
    def test_successful_request(self) -> None:
        ...
        bots_config = {
            'helloworld': {
                'email': 'helloworld-bot@wyzepal.com',
        ...
        self.assert_bot_server_response(available_bots=available_bots,
                                        ...
                                        event=dict(message={'content': "@**test** test message"},
                                                   bot_email='helloworld-bot@wyzepal.com',
                                                   trigger='mention',
                                                   token='abcd1234'),
    ...
    def test_request_for_unkown_bot(self) -> None:
        ...
        self.assert_bot_server_response(available_bots=['helloworld'],
                                        event=dict(message={'content': "test message"},
                                                   bot_email='unknown-bot@wyzepal.com'),
                                        bots_config=bots_config,
                                        check_success=False)
    ...
    @mock.patch('wyzepal_bots.lib.StateHandler')
    ...
    @mock.patch('sys.argv', ['wyzepal-botserver', '--config-file', '/foo/bar/baz.conf'])
