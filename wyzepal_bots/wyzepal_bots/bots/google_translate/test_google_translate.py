...
from wyzepal_bots.test_lib import BotTestCase, DefaultTests, StubBotHandler
from wyzepal_bots.bots.google_translate.google_translate import TranslateError
...
class TestGoogleTranslateBot(BotTestCase, DefaultTests):
    ...
    def test_exception(self):
        with patch('wyzepal_bots.bots.google_translate.google_translate.translate',
