...
from wyzepal_bots.test_lib import BotTestCase, DefaultTests, get_bot_message_handler, StubBotHandler
...
class TestWitaiBot(BotTestCase, DefaultTests):
    ...
    def test_normal(self) -> None:
        with patch('wyzepal_bots.bots.witai.witai.get_handle', return_value=mock_handle):
