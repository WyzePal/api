...
from wyzepal_bots.finder import import_module_from_source, resolve_bot_path
from wyzepal_bots.simple_lib import TerminalBotHandler

current_dir = os.path.dirname(os.path.abspath(__file__))

def parse_args():
    description = '''
        This tool allows you to test a bot using the terminal (and no WyzePal server).
...
def main():
    ...
    sender_email = 'foo_sender@wyzepal.com'
    ...
    try:
        ...
        print("\n\nOk, if you're happy with your terminal-based testing, try it out with a WyzePal server.",
              "\nYou can refer to https://wyzepalchat.com/api/running-bots#running-a-bot.")
        sys.exit(1)
