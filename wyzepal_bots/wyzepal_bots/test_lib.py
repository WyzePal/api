...
from wyzepal_bots.custom_exceptions import (
    ConfigValidationError,
)

from wyzepal_bots.request_test_lib import (
    mock_http_conversation,
    mock_request_exception
)

from wyzepal_bots.simple_lib import (
    SimpleStorage,
    SimpleMessageServer,
)

from wyzepal_bots.test_file_utils import (
    get_bot_message_handler,
    read_bot_fixture_data,
)

from wyzepal_bots.lib import BotIdentity
...
class BotTestCase(unittest.TestCase):
    ...
    def mock_config_info(self, config_info: Dict[str, str]) -> Any:
        return unittest.mock.patch('wyzepal_bots.test_lib.StubBotHandler.get_config_info', return_value=config_info)
