...
from wyzepal_bots.bots.virtual_fs.virtual_fs import sample_conversation
...
class TestVirtualFsBot(BotTestCase, DefaultTests):
    ...
    def test_multiple_recipient_conversation(self) -> None:
        ...
        with patch('wyzepal_bots.test_lib.BotTestCase.make_request_message', return_value=message):
