...
from wyzepal_bots.bots.trivia_quiz.trivia_quiz import (
...
class TestTriviaQuizBot(BotTestCase, DefaultTests):
    ...
    def test_answers(self) -> None:
        ...
        with patch('wyzepal_bots.bots.trivia_quiz.trivia_quiz.get_quiz_from_id',
        ...
        with patch('wyzepal_bots.bots.trivia_quiz.trivia_quiz.get_quiz_from_id',
                   return_value=json.dumps(quiz)):
            with patch('wyzepal_bots.bots.trivia_quiz.trivia_quiz.start_new_quiz') as mock_new_quiz:
