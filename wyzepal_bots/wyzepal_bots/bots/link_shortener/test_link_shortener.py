...
from wyzepal_bots.test_lib import StubBotHandler
from wyzepal_bots.bots.link_shortener.link_shortener import LinkShortenerHandler
...
class TestLinkShortenerBot(BotTestCase, DefaultTests):
    ...
    def test_normal(self) -> None:
        with self.mock_http_conversation('test_normal'):
            self._test('Shorten https://www.github.com/wyzepal/wyzepal please.',
                       'https://www.github.com/wyzepal/wyzepal: http://bit.ly/2Ht2hOI')
