from wyzepal_bots.test_lib import BotTestCase, DefaultTests, StubBotHandler, read_bot_fixture_data
...
def mock_salesforce_commands_types() -> Iterator[None]:
    with patch('wyzepal_bots.bots.salesforce.utils.commands', mock_commands), \
            patch('wyzepal_bots.bots.salesforce.utils.object_types', mock_object_types):
        yield
