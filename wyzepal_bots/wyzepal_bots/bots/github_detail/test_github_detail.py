from wyzepal_bots.test_lib import (
    StubBotHandler,
    BotTestCase,
    DefaultTests,
...
class TestGithubDetailBot(BotTestCase, DefaultTests):
    ...
    mock_config = {'owner': 'wyzepal', 'repo': 'wyzepal'}
    ...
    def test_issue(self) -> None:
        request = 'wyzepal/wyzepal#5365'
        bot_response = '**[wyzepal/wyzepal#5365](https://github.com/wyzepal/wyzepal/issues/5365)'\
    ...
    def test_pull_request(self) -> None:
        request = 'wyzepal/wyzepal#5345'
        bot_response = '**[wyzepal/wyzepal#5345](https://github.com/wyzepal/wyzepal/pull/5345)'\
    ...
    def test_404(self) -> None:
        request = 'wyzepal/wyzepal#0'
        bot_response = 'Failed to find issue/pr: wyzepal/wyzepal#0'
    ...
    def test_help_text(self) -> None:
        ...
        bot_response = 'This plugin displays details on github issues and pull requests. '\
                       ...
                       '#3212 wyzepal#3212 wyzepal/wyzepal#3212\nThe default owner is wyzepal and '\
                       'the default repo is wyzepal.'

        with self.mock_config_info(self.mock_config):
            self.verify_reply(request, bot_response)

    def test_too_many_request(self) -> None:
        request = 'wyzepal/wyzepal#1 wyzepal/wyzepal#1 wyzepal/wyzepal#1 wyzepal/wyzepal#1 '\
                  'wyzepal/wyzepal#1 wyzepal/wyzepal#1 wyzepal/wyzepal#1 wyzepal/wyzepal#1'
